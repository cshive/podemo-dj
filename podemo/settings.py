"""
Django settings for podemo project.
...
SECRET_KEY = 'k7v2ece#-@j5(p@7qdwnxgu#ni8&rxt!6^_7h6nb_9d7&ko7v4'
...
ROOT_URLCONF = 'podemo.urls'

WSGI_APPLICATION = 'podemo.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, '/local/content/ctrp/storage/db.sqlite3'),
...
STATICFILES_DIRS = (
    ...
    '/local/content/ctrp/apps/podemo/static/',
)
